...
var query = context.Persons.Join(,)
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=LAPTOP-EFPS8KL8;Database=ComplexQueries;User ID=LAPTOP-EFPS8KL8\\huawei;Trusted_Connection=True");
    }
}